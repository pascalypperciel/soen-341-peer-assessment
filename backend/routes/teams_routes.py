...
def display_teams_student():
    ...
    try:
        ...
        if not groups_result:
            return jsonify({"message": "No groups for this student!"}), 404
...
def delete_team():
    ...
    try:
        ...
        delete_ratings_query = "DELETE FROM Ratings WHERE GroupID = ?"
        cursor.execute(delete_ratings_query, (team_id,))
